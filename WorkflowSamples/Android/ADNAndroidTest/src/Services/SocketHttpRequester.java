package Services;
 //http://www.open-open.com/lib/view/open1361088530509.html
...
public class SocketHttpRequester {
	...
	public static boolean ADNPost(String path, Map<String, String> params, File uploadfile) throws Exception{     
              
        long fileDataLength = uploadfile.length();
